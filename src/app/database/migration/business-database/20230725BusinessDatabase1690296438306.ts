...
export class BusinessDatabase1690296438306 implements MigrationInterface {
  async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query('CREATE TABLE `account_auth_group` (`accountId` int NOT NULL, `groupId` varchar(36) NOT NULL, PRIMARY KEY (`accountId`, `groupId`)) ENGINE=InnoDB');
    await queryRunner.query('CREATE INDEX `IDX_82353795ba05400818e15bc26b` ON `account_auth_group` (`accountId`)');
    await queryRunner.query('CREATE INDEX `IDX_df6873242d7ce56e52a05fc0e5` ON `account_auth_group` (`groupId`)');
